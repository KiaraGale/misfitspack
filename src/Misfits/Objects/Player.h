...
// Public Functions
extern bool32(*Player_CheckBadnikTouch)(EntityPlayer* player, void* entity, Hitbox* entityHitbox);
extern bool32(*Player_CheckBadnikBreak)(EntityPlayer* player, void* entity, bool32 destroy);
